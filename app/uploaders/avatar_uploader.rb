...
class AvatarUploader < CarrierWave::Uploader::Base
  ...
  def manualcrop
    manipulate! do |img|
      ...
      #end
      if model.cropping?
        raise [model.crop_x.to_i,model.crop_y.to_i,model.crop_h.to_i,model.crop_w.to_i].join(" ")
        img = img.crop(model.crop_x.to_i,model.crop_y.to_i,model.crop_h.to_i,model.crop_w.to_i)
        #p [model.crop_x.to_i,model.crop_y.to_i,model.crop_h.to_i,model.crop_w.to_i].join(' ')
      end
      img
    end
  end
